...
import com.example.b2023gr2sw.ui.theme.BEntrenador

class FRecyclerViewAdaptadorNombreDescripcion(
    private val contexto: FRecyclerView,
    private val lists: ArrayList<BEntrenador>,
...
//contexto.aumentar Totallikes()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            ...
            val entrenadorActual = this.lists[position]
